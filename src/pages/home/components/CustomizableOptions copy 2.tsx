...
const CustomizableOptions: React.FC = () => {
  ...
  return (
    <section className="bg-gradient-to-br from-black via-gray-900 to-gray-800 py-16 px-4">
        ...
        {/* <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 auto-rows-[200px] gap-4">
          {options.map((item, i) => (
            ...
            >
              ...
              ></div>
              <div className="absolute inset-0 bg-black/50 group-hover:bg-black/30 transition-all backdrop-blur-sm p-4 flex flex-col justify-end">
